    ...
    <div class="main-container">
        ...
        <div class="input-section">
            ...
            <div class="input-group">
                <input class="time-input" type="number" min="0" v-model="ValueMin" placeholder="Minutes" />
                <span>:</span>
                <input class="time-input" type="number" min="0" max="59" v-model="ValueSeconds" placeholder="Seconds" />
            </div>
            <div class="zone-selection">
                <label for="zoneDropdown">Select a Zone:</label>
                <select v-model="Valuezone" id="zoneDropdown" class="zone-dropdown">
